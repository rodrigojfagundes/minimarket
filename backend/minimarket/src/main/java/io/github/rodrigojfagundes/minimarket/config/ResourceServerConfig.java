package io.github.rodrigojfagundes.minimarket.config;
...
//	private static final String[] PUBLIC = { "/oauth/token", "/h2-console/**", "/swagger-ui/**" };
	...
	private static final String[] POST_PRODUCT = { "/products" };
	private static final String[] VISITOR_AND_MEMBER = { "/categories", "products" };	
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.POST, POST_PRODUCT).hasRole("MEMBER")
